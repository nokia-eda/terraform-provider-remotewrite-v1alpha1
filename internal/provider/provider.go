...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-remotewrite/internal/eda/apiclient"
	"github.com/nokia/eda/apps/terraform-provider-remotewrite/internal/eda/utils"
	"github.com/nokia/eda/apps/terraform-provider-remotewrite/internal/tfutils"
)
...
var _ provider.Provider = (*remotewriteProvider)(nil)

func New(ver string) func() provider.Provider {
	return func() provider.Provider {
		return &remotewriteProvider{version: ver}
	}
}
...
func (p *remotewriteProvider) Schema(ctx context.Context, req provider.SchemaRequest, resp *provider.SchemaResponse) {
...
func (p *remotewriteProvider) Configure(ctx context.Context, req provider.ConfigureRequest, resp *provider.ConfigureResponse) {
...
func (p *remotewriteProvider) Metadata(ctx context.Context, req provider.MetadataRequest, resp *provider.MetadataResponse) {
	resp.TypeName = "remotewrite-v1alpha1"
	resp.Version = p.version
}

func (p *remotewriteProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
...
func (p *remotewriteProvider) Resources(ctx context.Context) []func() resource.Resource {
