...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-remotewrite/internal/resource_export"
	"github.com/nokia/eda/apps/terraform-provider-remotewrite/internal/tfutils"
)

const (
	create_rs_export = "/apps/remotewrite.eda.nokia.com/v1alpha1/namespaces/{namespace}/exports"
	read_rs_export   = "/apps/remotewrite.eda.nokia.com/v1alpha1/namespaces/{namespace}/exports/{name}"
	update_rs_export = "/apps/remotewrite.eda.nokia.com/v1alpha1/namespaces/{namespace}/exports/{name}"
	delete_rs_export = "/apps/remotewrite.eda.nokia.com/v1alpha1/namespaces/{namespace}/exports/{name}"
)
