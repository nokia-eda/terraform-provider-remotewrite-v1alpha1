...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-remotewrite/internal/datasource_destination"
...
const read_ds_destination = "/apps/remotewrite.eda.nokia.com/v1alpha1/namespaces/{namespace}/destinations/{name}"
