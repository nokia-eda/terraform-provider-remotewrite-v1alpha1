...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-remotewrite/internal/datasource_export"
...
const read_ds_export = "/apps/remotewrite.eda.nokia.com/v1alpha1/namespaces/{namespace}/exports/{name}"
