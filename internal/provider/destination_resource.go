...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-remotewrite/internal/resource_destination"
	"github.com/nokia/eda/apps/terraform-provider-remotewrite/internal/tfutils"
)

const (
	create_rs_destination = "/apps/remotewrite.eda.nokia.com/v1alpha1/namespaces/{namespace}/destinations"
	read_rs_destination   = "/apps/remotewrite.eda.nokia.com/v1alpha1/namespaces/{namespace}/destinations/{name}"
	update_rs_destination = "/apps/remotewrite.eda.nokia.com/v1alpha1/namespaces/{namespace}/destinations/{name}"
	delete_rs_destination = "/apps/remotewrite.eda.nokia.com/v1alpha1/namespaces/{namespace}/destinations/{name}"
)
