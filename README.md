# terraform-provider-remotewrite-v1alpha1

terraform-provider-remotewrite-v1alpha1 is a terraform provider plugin for the `remotewrite` resource in Nokia EDA.
