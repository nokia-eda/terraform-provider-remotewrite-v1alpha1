---
page_title: "remotewrite-v1alpha1 Provider"
---

# remotewrite-v1alpha1 Provider

This provider is used to interact with the resources provided by the **remotewrite-v1alpha1** application of the [Nokia EDA](https://docs.eda.dev) platform.
